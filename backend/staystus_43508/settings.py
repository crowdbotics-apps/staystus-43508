"""
Django settings for staystus_43508 project.
...
ROOT_URLCONF = 'staystus_43508.urls'
...
WSGI_APPLICATION = 'staystus_43508.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "staystus_43508 API",
    "DESCRIPTION": "API documentation for staystus_43508 App",
    "VERSION": "v1",
}
